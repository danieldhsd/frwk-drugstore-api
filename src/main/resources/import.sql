...
insert into tb_account_financial_instituition (account, agency, client_id, created_at, financial_instituition_id, updated_at) values ('15659-9', '20456', 1, current_timestamp, 1, current_timestamp);